...
// Central 3D Platform with Holographic Avatar Core
const CentralAvatarPlatform = () => {
  ...
  return (
    <group ref={centralGroup} position={[0, -0.05, 0]}>
      {/* Multi-layered Glowing Circular Pedestals */}
      ...
      <Sphere args={[0.28, 32, 32]} position={[0, 0.14, 0]}>
        <MeshDistortMaterial
          color="#060919"
          emissive="#38bdf8"
      ...
      {/* Glowing Neon ASHUTOSH Badge */}
      <Html distanceFactor={6.8} position={[0, -0.22, 0.32]} center zIndexRange={[50, 60]}>
        <div className="px-4 py-1.5 rounded-full bg-[#060919]/98 border border-cyan-400 shadow-[0_0_22px_rgba(0,240,255,0.7)] text-center select-none whitespace-nowrap">
          <p className="text-[12px] font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-amber-300 to-cyan-400 leading-tight">
            ASHUTOSH
          </p>
          <p className="text-[7.5px] font-mono font-bold uppercase tracking-wider text-cyan-300">
            Founder • AI • Engineer
          </p>
        </div>
      </Html>
